cask "cc-gateway-pro" do
  version "3.15.13"
  sha256 "2504b5d703d9a41ebb7228ee0ae9d1260a6137d9e1a02dff8b2335c77318e61a"

  url "https://github.com/KeaneFeng/cc-gateway-pro/releases/download/v#{version}/CC.Gateway.Pro_3.15.13_aarch64.dmg"
  name "CC Gateway Pro"
